...
$mail->Subject = $etitle.' starts for the next 24 hours';
$mail->msgHTML("
<h3>$etitle will start after 24 hours. please make sure that you can logged in and cast your vote within the allotted period of time.</h3>


<h4>Always remember to make wise decisions. <br><br>Vote Wisely! Your vote matters!</h4>
");
                     }
       $updt = "UPDATE `election_sched` SET `notification`=1 WHERE  election_id = '$elecid'";
